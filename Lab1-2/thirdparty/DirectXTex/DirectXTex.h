...
namespace DirectX
{
    ...
    HRESULT __cdecl CaptureTexture1(_In_ ID3D11Device* pDevice, _In_ ID3D11DeviceContext* pContext, _In_ ID3D11Resource* pSource, _Out_ ScratchImage& result) noexcept;
#endif
    ...
    HRESULT __cdecl CaptureTexture1(
